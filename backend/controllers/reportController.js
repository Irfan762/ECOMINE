...
exports.downloadReport = async (req, res) => {
  try {
    const report = await Report.findById(req.params.id).populate('assessmentId');
...
0 -25 Td
/F1 12 Tf
(Energy: ${assessment?.results?.energy?.value || 'N/A'} GJ/t) Tj
0 -20 Td
(CO2 Emissions: ${assessment?.results?.co2?.value || 'N/A'} t/t) Tj
0 -20 Td
(Water Usage: ${assessment?.results?.water?.value || 'N/A'} m3/t) Tj
0 -40 Td
/F1 10 Tf
